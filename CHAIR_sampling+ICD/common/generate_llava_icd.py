...
generate_llava.py (cd_alpha=1.0, cd_beta=0.2, max_new_tokens=256, same 500
...
unmodified, and ICD is directly comparable to VCD/SID in this package. Note
this cd_beta (0.2) intentionally does NOT match the paper's own default
(0.1) or this project's earlier llava-bench ICD run (which used 0.1) --
it is deliberately set to match this package's internal VCD/SID convention
instead, for apples-to-apples comparison within this experiment family.
...
MAX_NEW_TOKENS = 256
CD_ALPHA = 1.0
CD_BETA = 0.2  # matches this package's VCD/SID convention, not the ICD paper's 0.1 -- see module docstring
