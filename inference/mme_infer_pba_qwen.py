"""MME PBA inference for Qwen2.5-VL-7B-Instruct.

Qwen counterpart of ``mme_infer_pba.py``. PBA is purely a prompt intervention:
identical to the base script except the question is suffixed with
``PBA_SUFFIX`` ("... Answer yes whenever possible."). No logit surgery. Run
greedy (temperature 0), mirroring the LLaVA PBA driver.
"""
