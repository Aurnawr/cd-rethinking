...
for dataset in ${datasets[@]}; do 
    for type in ${types[@]}; do
        ...
        python ./inference/pope_infer_pba.py \
            ...
            --answers-file ./outputs/pope/pba/llava-13b-${dataset}-${type}-greedy.jsonl \
            --temperature 0 \
            --conv-mode vicuna_v1
    done
done
...
for dataset in ${datasets[@]}; do 
    for type in ${types[@]}; do
        ...
        python ./inference/pope_infer_olm.py \
            ...
            --question-file ./data/pope/${dataset}/${dataset}_pope_${type}.json \
            --image-folder ./data/pope/${dataset}/images \
            --answers-file ./outputs/pope/olm/llava-13b-${dataset}-${type}-greedy.jsonl \
            --temperature 0 \
            --conv-mode vicuna_v1 \
            --use-olm
    done
...
for dataset in ${datasets[@]}; do 
    for type in ${types[@]}; do
        ...
        python ./inference/pope_infer_apc.py \
            ...
            --question-file ./data/pope/${dataset}/${dataset}_pope_${type}.json \
            --image-folder ./data/pope/${dataset}/images \
            --answers-file ./outputs/pope/apc/llava-13b-${dataset}-${type}-sample.jsonl \
            --temperature 1 \
            --conv-mode vicuna_v1 \
            --use-apc
    done
